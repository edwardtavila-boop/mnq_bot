...
class V1DetectorConfig:
    ...
    # Entry refinement
    entry_mode: str = "market"  # "market" or "pullback" — pullback uses limit at signal_close - pullback_atr*ATR
...
def main():
    ...
    p.add_argument("--exit-mode", default="r_multiple",
    ...
    p.add_argument("--ema-dow", default="Skip Thursday",
