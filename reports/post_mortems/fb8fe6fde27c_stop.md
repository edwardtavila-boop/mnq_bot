# Post-Mortem — fb8fe6fde27c427eaf84ca4a0c0ca29c (LOSS)
...
LONG entry on 2026-01-11T14:07:00+00:00 against a `high_vol` tape. Exit via `stop` at 19987.50 vs entry 19991.00.

## Evidence

- PnL: $-7.74 (commission $+0.74)
- Entry slippage: +2.0 ticks; exit slippage: +0.0 ticks.
...
```
order_id           = fb8fe6fde27c427eaf84ca4a0c0ca29c
side               = long
entry_ts / exit_ts = 2026-01-11T14:07:00+00:00 → 2026-01-11T14:08:00+00:00
entry / exit price = 19991.00 → 19987.50
pnl_dollars        = -7.7400
commission         = +0.7400
exit_reason        = stop
regime             = high_vol
