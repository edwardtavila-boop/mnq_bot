...
class ATR:
    ...
    def __init__(self, length: int = 14) -> None:
        ...
        # source is unused — we feed TR directly through RMA.step().
        self._rma = RMA(length=self.length, source="close")
    ...
    def update(self, bar: Bar) -> float | None:
        ...
        # Feed TR through RMA's public scalar step — no private-attr mutation.
        self._value = self._rma.step(tr)
        return self._value
